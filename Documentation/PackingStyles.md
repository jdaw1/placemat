...
This can be done by adding to the array an extra flag or flags, `/SuppressOrnamentsLeft`, `/SuppressOrnamentsCentre`, `/SuppressOrnamentsRight`, which for the pages using that packing style suppresses the unwanted headers, footers, icons, and water boxes. 
